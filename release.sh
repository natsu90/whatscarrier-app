...
jarsigner -sigalg SHA1withRSA -digestalg SHA1 -keystore $company.keystore platforms/android/build/outputs/apk/android-release-unsigned.apk whatscarrier
cp platforms/android/build/outputs/apk/android-release-unsigned.apk platforms/android/build/outputs/apk/my.com.$company.$appname.v$version-unaligned.apk
...
/Users/sulaiman/Library/Android/sdk/build-tools/22.0.1/zipalign -v 4 platforms/android/build/outputs/apk/my.com.$company.$appname.v$version-unaligned.apk releases/com.$company.$appname.v$version.apk
